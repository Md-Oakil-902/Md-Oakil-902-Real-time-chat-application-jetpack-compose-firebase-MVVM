...
@Composable
fun ChatBubble(messages: Message) {
    val isCurrentUser = messages.senderId == Firebase.auth.currentUser?.uid
    ...
    Row(
        ...
        if(isCurrentUser) Alignment.CenterStart else Alignment.CenterEnd
